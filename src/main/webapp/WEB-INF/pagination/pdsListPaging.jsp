   ...
   <ul class="pagination">
	    <c:choose>	     
		     <c:when test="${searchVo.pagination.existPrevPage}">
		  	    <li class ="page-item"><a class ="page-link" href="/Pds/List?nowpage=1">처음</a> </li>
	      		<li class ="page-item prev_item"><a class ="page-link" href="/Pds/List?nowpage=${prevPage}">⏪</a> </li>
		     </c:when>
		     <c:otherwise>
		   ...
		   <c:forEach  var="pagenum"  begin="${startnum}"  end="${endnum}"  step="1">
		     <c:choose>
		       <c:when test="${pagenum eq searchVo.pagination.currentPage}">
			        <li class="page-item"><a class="page-link" href="/Pds/List?nowpage=${ pagenum }"
		   ...
		   <c:choose>
		   	<c:when test="${searchVo.pagination.existNextPage}">
		   		<li class ="page-item next_item"><a class ="page-link" href="/Pds/List?nowpage=${ nextPage}">⏩</a> </li>
		        <li class ="page-item"><a class ="page-link" href="/Pds/List?nowpage=${ totalpagecount }">마지막</a> </li>
		   	</c:when>
		   	<c:otherwise>
