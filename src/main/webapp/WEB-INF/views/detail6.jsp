			...
			<section id="intro">
				...
				<div class="right">
					<div id="starRating" class="starContainer">
						...
						<div class="avgStar"></div>
						<div class="avgStar"></div>
						<span><a href="#section2" style="font-size:15px;">${recount}건의 구매후기 > </a></span>
					</div>
					<div style="font-weight: 540; color:#0facbb;">제조사 : ${ prod.brand_name }</div>
					...
					<div id="pro_price">
						<span style=" font-size:30px; font-weight:1000;">${f_Price}</span>원<span>
					</div>
					<hr>
					<div style="font-weight: bold; color:#ED7802;">
						<c:choose>
							<c:when test="${prod.stock_count > 0 }"> 재고 있음 </c:when>
							<c:when test="${prod.stock_count == 0 }"> 재고 없음 </c:when>
					  </c:choose>
					</div>
					<hr>
					<div>상품형태 : ${ prod.form_type }</div>
					<hr>
					<div>
						<ion-icon name="airplane-outline"></ion-icon> 단일 상품 25,000원이상 구매시 무료배송
					</div>
				</div>
			</section>
			<!-- 맨 위 요약페이지 끝 -->
        ...
        <p>저희는 상품의 사진과 자료를 홈페이지에 반영하기 위해 노력하고 있습니다. 하지만 제조사가 포장이나 성분을 업데이트하는 경우 사이트에 반영되기까지 시간이 소요될 수 있습니다. 상품의 패키지는 다를 수 있으며 이는 검증된 번역으로 다를 수 있습니다. 일부 상품의 정보는 고객님의 편의를 위해 기계 번역되었습니다. 이는 검증된 번역으로 이틀 시일 내에 수정될 예정입니다.</p>
            ...
            <div class="table-container" >
                <table>
                    <thead>
                        <tr>
                            <th colspan="3"><h2>영양 성분 정보</h2></th>
                        </tr>
                        <tr>
                            <th colspan="3">1회 제공량: 캡슐 2정</th>
                        </tr>
                        <tr>
                            <th colspan="3">용기당 제공 횟수: 60회</th>
                        </tr>
                        <tr>
                            <th></th>
                            <th>1회 제공량당</th>
			...
			<section id="section2">
				<h1 style="border-bottom: 1px solid #ccc;">구매 후기(${recount}건)</h1>
