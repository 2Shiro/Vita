			...
			<div class="card bg-white" style="border-radius: 1rem;">
				...
				<div class="card-body p-5 tab1 active">
					...
					<section class="section_naver">
						<a class="btn_signup_naver" href="http://localhost:8080/oauth2/authorization/naver"> <img
					...
					<div class="mb-2">
						<form id="loginForm" action="/login" method="POST">
							...
							<button id ="loginButton" class="submit" type="button" class="btn btn-primary">기존
								회원 로그인</button>
						</form>
	...
	document.addEventListener('DOMContentLoaded', function() {
		 const loginButton = document.getElementById('loginButton');
		    loginButton.addEventListener('click', function() {
		        ...
		        .then(response => {
		            if (response.ok) {
		                return response.text(); // JSON이 아닌 텍스트를 반환
		            } else {
