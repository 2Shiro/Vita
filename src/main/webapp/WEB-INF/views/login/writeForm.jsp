		...
		<div class="content">
			<div class="card bg-white" style="border-radius: 1rem;">
				...
				<div class="card-body p-5">
					...
					<div class="mb-2">
						<form id="registerForm" action="/login/write" method="POST">
							<div class="form_list">
								<div class="form_item" >
							...
							<div class="form_list">
								...
								<input type="hidden" name="birth" id="user_social_num" value="">
								<div class="form_item" >
							...
							<div class ="address"> 
							  ...
							  <input type="text" id="address02" name ="zipcode"  placeholder="우편번호" readonly="readonly"/>
							  <input type="button"  onclick="daumPost()" value="우편번호 찾기" />
							  <input type="text" id="fullAddr" name ="address"  placeholder="주소" readonly="readonly">
							  <input type="text" id="address_detail"name="addressdetail" placeholder="상세주소" />
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function(){
    	   ...
    	   // 이름 입력 필드 선택
        let userEmailEl = document.querySelector('[name="email"]');
      ...
      /*   function checkEmail(){
		...
		function isMatch (password1, password2) {
		 ...
		 let userNameEl = document.querySelector('[name="name"]');
